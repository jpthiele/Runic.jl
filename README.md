...
This assumes that Runic is installed in the `@runic` shared project and that the alias is set as suggested in the [Installation](#installation) section above.

```
(push '(runic . ("runic" filepath)) apheleia-formatters)
